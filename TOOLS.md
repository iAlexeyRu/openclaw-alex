...
- GitHub SSH key for this host: `~/.ssh/id_ed25519_github_openclaw`
- Public key comment: `alice-openclaw@github`
- Current public key path: `~/.ssh/id_ed25519_github_openclaw.pub`
